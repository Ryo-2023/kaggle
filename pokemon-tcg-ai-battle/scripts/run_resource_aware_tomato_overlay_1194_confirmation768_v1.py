#!/usr/bin/env python3
"""Research-only 768 confirmation for the 1182→1194 Colress swap."""
...
OUTPUT_DEFAULT = ROOT / "runs/final-sprint-autonomous/resource-aware-tomato-overlay-1194-confirmation768-1182-v1-20260814"
CANDIDATE_ID = "surface-1182-to-1194"
MUTATION = {"removed_cards": [1182], "added_cards": [1194]}
CONFIRMATION_BASE_SEED = 22850000
WARMUP_BASE_SEED = 22840000
CONFIRMATION_REPETITIONS = 16
RECYCLE_GAMES = 64


def _configure() -> None:
    _base.SCHEMA = "meta-specialist-resource-aware-tomato-overlay-1194-confirmation768-v1"
    ...
    _base.CONFIRMATION_GAMES_PER_OPPONENT_SEAT = CONFIRMATION_REPETITIONS
    ...
    def write_text(path: Path, text: str) -> str:
        if path.name == "confirmation_summary.md":
            text = text.replace("# b92a resource-aware 384 confirmation", "# Colress support resource-aware 768 confirmation")

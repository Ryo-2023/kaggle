#!/usr/bin/env python3
"""Materialize one 48-game weighted ATTACH/END action screen (no execution)."""
...
def _write_new(path: Path, value: object) -> None:
    ...
    try:
        ...
        try:
            ...
            raise FileExistsError(f"refusing to replace existing weighted screen: {path}") from exc
    finally:

#!/usr/bin/env python3
"""Run seed-disjoint 768 confirmation for the positive two-card package."""
...
CONFIRMATION_SCHEMA = "meta-specialist-rule-v0-root-deck-coordinated-package-confirmation768-v1"
...
confirmation.DEFAULT_BASE_SEED = 23_684_000
confirmation.GAMES_PER_SEAT = 16
confirmation.DEFAULT_WORKER_RECYCLE_GAMES = 64
confirmation.OUTPUT_DEFAULT = (
    confirmation.ROOT
    / "runs/final-sprint-autonomous/rule-v0-root-deck-package-confirmation768-v1-20260814"
)

#!/usr/bin/env python3
"""Rebind a cross-lineage split after fault-free smoke promotion."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        report = build_cross_lineage_split_v1(output_root=args.output_root, p1_package=args.p1_package)
